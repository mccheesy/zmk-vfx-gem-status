...
#include <zmk_vfx_gem_status/battery.h>
#include <zmk_vfx_gem_status/layer.h>
#include <zmk_vfx_gem_status/output.h>
#include <zmk_vfx_gem_status/profile.h>
#include <zmk_vfx_gem_status/screen.h>
#include <zmk_vfx_gem_status/wpm.h>
